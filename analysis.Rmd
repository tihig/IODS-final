...
It's clear that our hypothesis with gender is proven to be false, so I'll continue with a logistic model without gender as explanatory variable.
...
```{r curve, echo=FALSE}
plot(learn$interest,learn$prediction,xlab="Interest",ylab="Prediction", col="#114882")
curve(predict(m, data.frame(interest = x), type = "response"),add=TRUE, col="forestgreen") 
points(learn$interest,fitted(m),pch=20)
```
